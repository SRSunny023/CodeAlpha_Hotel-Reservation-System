...
public class Add_Room extends JFrame {
    ...
    Add_Room() {
        ...
        ImageIcon imageIcon = new ImageIcon(Welcome.BED_ICON);
            ...
            public void actionPerformed(ActionEvent aE) {
                try {
                    ...
                    try {
                        ...
                        JOptionPane.showMessageDialog(null, "Room number must be a number!", "Error",
                                JOptionPane.ERROR_MESSAGE);
                        return;
                    }

                    if (roomExists(roomNumber)) {
                        JOptionPane.showMessageDialog(null, "Room number already exists!", "Duplicate Room",
                                JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                    ...
                    FileWriter fw = new FileWriter(Welcome.ROOM_FILE, true);
