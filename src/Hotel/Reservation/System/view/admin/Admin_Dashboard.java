...
import Hotel.Reservation.System.view.auth.Login;
...
public class Admin_Dashboard extends JFrame {
    ...
    public Admin_Dashboard() {
        ...
        manageRooms.setBounds(LABEL_X_POSITION, DISTANCE + (1 * DISTANCE_GAP), Add_Room.LABEL_WIDTH,
        ...
        manageUser.setBounds(LABEL_X_POSITION, DISTANCE + (2 * DISTANCE_GAP), Add_Room.LABEL_WIDTH,
                Add_Room.LABEL_HEIGHT);
        ...
        allReservations.setBounds(LABEL_X_POSITION, DISTANCE + (3 * DISTANCE_GAP), Add_Room.LABEL_WIDTH,
                Add_Room.LABEL_HEIGHT);
        ...
        paymentRecords.setBounds(LABEL_X_POSITION, DISTANCE + (4 * DISTANCE_GAP), Add_Room.LABEL_WIDTH,
                Add_Room.LABEL_HEIGHT);
        ...
        reports.setBounds(LABEL_X_POSITION, DISTANCE + (5 * DISTANCE_GAP), Add_Room.LABEL_WIDTH, Add_Room.LABEL_HEIGHT);
        ...
        logout.setBounds(LABEL_X_POSITION, DISTANCE + (6 * DISTANCE_GAP), Add_Room.LABEL_WIDTH, Add_Room.LABEL_HEIGHT);
        ...
        exit.setBounds(LABEL_X_POSITION, DISTANCE + (7 * DISTANCE_GAP), Add_Room.LABEL_WIDTH, Add_Room.LABEL_HEIGHT);
