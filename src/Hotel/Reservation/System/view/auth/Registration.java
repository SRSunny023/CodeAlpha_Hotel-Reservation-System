...
public class Registration extends JFrame implements ActionListener {
    ...
    private void registerUser() {
        ...
        if (username.isEmpty() || email.isEmpty() || password.isEmpty() || confirmPassword.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(this, "Please fill all fields!", "Registration Error",
        ...
        if (!email.contains("@") || !email.contains(".")) {
            ...
            JOptionPane.showMessageDialog(this, "Please enter a valid email address!", "Registration Error",
                    JOptionPane.ERROR_MESSAGE);
            return;
        ...
        try {
            ...
            FileWriter writer = new FileWriter(Welcome.USERS_FILE, true);
            writer.write(username + "|" + email + "|" + password + "|" + role + "\n");
            writer.close();

            FileWriter fw = new FileWriter(Welcome.USER_PROFILE, true);
            fw.write(username + "|" + "" + "|" + "" + "|" + "" + "|" + "" + "\n");
            fw.close();
