...
public class User_Dashboard extends JFrame {
    ...
    public User_Dashboard() {
        ...
        ImageIcon imageIcon = new ImageIcon(Welcome.WELCOME_ICON);
        ...
        searchRooms.setBounds(Admin_Dashboard.LABEL_X_POSITION, Admin_Dashboard.DISTANCE, Add_Room.LABEL_WIDTH,
                Add_Room.LABEL_HEIGHT);
        ...
        makeReservation.setBounds(Admin_Dashboard.LABEL_X_POSITION,
                Admin_Dashboard.DISTANCE + (1 * Admin_Dashboard.DISTANCE_GAP), Add_Room.LABEL_WIDTH,
                Add_Room.LABEL_HEIGHT);
        ...
        myReservations.setBounds(Admin_Dashboard.LABEL_X_POSITION,
                Admin_Dashboard.DISTANCE + (2 * Admin_Dashboard.DISTANCE_GAP), Add_Room.LABEL_WIDTH,
                Add_Room.LABEL_HEIGHT);
        ...
        cancelReservation.setBounds(Admin_Dashboard.LABEL_X_POSITION,
                Admin_Dashboard.DISTANCE + (3 * Admin_Dashboard.DISTANCE_GAP), Add_Room.LABEL_WIDTH,
                Add_Room.LABEL_HEIGHT);
        ...
        payment.setBounds(Admin_Dashboard.LABEL_X_POSITION,
                Admin_Dashboard.DISTANCE + (4 * Admin_Dashboard.DISTANCE_GAP), Add_Room.LABEL_WIDTH,
                Add_Room.LABEL_HEIGHT);
        ...
        myPortfolio.setBounds(Admin_Dashboard.LABEL_X_POSITION,
                Admin_Dashboard.DISTANCE + (5 * Admin_Dashboard.DISTANCE_GAP), Add_Room.LABEL_WIDTH,
                Add_Room.LABEL_HEIGHT);
        ...
        logout.setBounds(Admin_Dashboard.LABEL_X_POSITION,
                Admin_Dashboard.DISTANCE + (6 * Admin_Dashboard.DISTANCE_GAP), Add_Room.LABEL_WIDTH,
                Add_Room.LABEL_HEIGHT);
        ...
        exit.setBounds(Admin_Dashboard.LABEL_X_POSITION, Admin_Dashboard.DISTANCE + (7 * Admin_Dashboard.DISTANCE_GAP),
                Add_Room.LABEL_WIDTH, Add_Room.LABEL_HEIGHT);
